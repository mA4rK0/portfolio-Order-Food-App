    ...
    return (
      <>
        <section className="flex flex-wrap justify-center items-center">
          ...
          <section className="border ease-in-out duration-300 transition hover:shadow-yes hover:opacity-80 hover:shadow-md text-lg text-bold rounded-full flex justify-center items-center w-7 h-7 bg-yes border-yes absolute ml-36">
